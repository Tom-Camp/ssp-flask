...
def components_list_view(project_name: str):
    ...
    return render_template("components/component_list_view.html", **data)
...
def components_add_component_view(project_name: str, component: str):
    ...
    return render_template("components/component_add_component_view.html", **data)


@component_bp.route(
    "/<project_name>/components/remove/<component>", methods=["GET", "POST"]
)
def components_remove_component_view(project_name: str, component: str):
    """
    A view for removing Components or individual component files.
